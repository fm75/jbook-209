...
<html>
  <head>
    ...
    <title>body-parser &#8212; Colab Experiment</title>
...
<main class="col py-md-3 pl-md-4 bd-content overflow-auto" role="main">
    ...
    <div class="dropdown-buttons">
        ...
        <!-- Download raw file -->
        <a class="dropdown-buttons" href="../../../../../../_sources/.cache/yarn/v6/npm-body-parser-1.19.0-96b2709e57c9c4e09a6fd66a8fd979844f69f08a-integrity/node_modules/body-parser/README.md"><button type="button"
...
<div class="dropdown-buttons-trigger">
    ...
    <div class="dropdown-buttons sourcebuttons">
        ...
        <a class="issues-button"
            href="https://github.com/fm75/jbook-209/issues/new?title=Issue%20on%20page%20%2F.cache/yarn/v6/npm-body-parser-1.19.0-96b2709e57c9c4e09a6fd66a8fd979844f69f08a-integrity/node_modules/body-parser/README.html&body=Your%20issue%20content%20here."><button
                type="button" class="btn btn-secondary topbarbtn" data-toggle="tooltip" data-placement="left"
                title="Open an issue"><i class="fas fa-lightbulb"></i>open issue</button></a>
        <a class="edit-button" href="https://github.com/fm75/jbook-209/edit/master/.cache/yarn/v6/npm-body-parser-1.19.0-96b2709e57c9c4e09a6fd66a8fd979844f69f08a-integrity/node_modules/body-parser/README.md"><button
                type="button" class="btn btn-secondary topbarbtn" data-toggle="tooltip" data-placement="left"
 ...
 <li class="toc-h2 nav-item toc-entry">
  ...
  <ul class="nav section-nav flex-column">
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#bodyparser-json-options">
     ...
     <li class="toc-h4 nav-item toc-entry">
      ...
      <ul class="nav section-nav flex-column">
       <li class="toc-h5 nav-item toc-entry">
        <a class="reference internal nav-link" href="#inflate">
         inflate
        </a>
       </li>
       <li class="toc-h5 nav-item toc-entry">
   ...
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#bodyparser-raw-options">
   ...
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#bodyparser-text-options">
    ...
    <ul class="nav section-nav flex-column">
     <li class="toc-h4 nav-item toc-entry">
      ...
      <ul class="nav section-nav flex-column">
       <li class="toc-h5 nav-item toc-entry">
        <a class="reference internal nav-link" href="#defaultcharset">
         defaultCharset
        </a>
       </li>
       <li class="toc-h5 nav-item toc-entry">
   ...
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#bodyparser-urlencoded-options">
    ...
    <ul class="nav section-nav flex-column">
     <li class="toc-h4 nav-item toc-entry">
      ...
      <ul class="nav section-nav flex-column">
       <li class="toc-h5 nav-item toc-entry">
        <a class="reference internal nav-link" href="#extended">
         extended
        </a>
       </li>
       <li class="toc-h5 nav-item toc-entry">
       ...
       <li class="toc-h5 nav-item toc-entry">
        <a class="reference internal nav-link" href="#parameterlimit">
         parameterLimit
        </a>
       </li>
       <li class="toc-h5 nav-item toc-entry">
 ...
 <li class="toc-h2 nav-item toc-entry">
  ...
  <ul class="nav section-nav flex-column">
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#content-encoding-unsupported">
     content encoding unsupported
    </a>
   </li>
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#request-aborted">
     request aborted
    </a>
   </li>
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#request-entity-too-large">
     request entity too large
    </a>
   </li>
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#request-size-did-not-match-content-length">
     request size did not match content length
    </a>
   </li>
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#stream-encoding-should-not-be-set">
     stream encoding should not be set
    </a>
   </li>
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#too-many-parameters">
     too many parameters
    </a>
   </li>
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#unsupported-charset-bogus">
     unsupported charset “BOGUS”
    </a>
   </li>
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#unsupported-content-encoding-bogus">
 ...
 <li class="toc-h2 nav-item toc-entry">
  ...
  <ul class="nav section-nav flex-column">
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#express-connect-top-level-generic">
     Express/Connect top-level generic
    </a>
   </li>
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#express-route-specific">
     Express route-specific
    </a>
   </li>
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#change-accepted-type-for-parsers">
 ...
 <li class="toc-h2 nav-item toc-entry">
  ...
  <div class="section" id="body-parser">
<h1>body-parser<a class="headerlink" href="#body-parser" title="Permalink to this headline">¶</a></h1>
...
<ul class="simple">
<li><p><a class="reference external" href="#bodyparserjsonoptions">JSON body parser</a></p></li>
<li><p><a class="reference external" href="#bodyparserrawoptions">Raw body parser</a></p></li>
<li><p><a class="reference external" href="#bodyparsertextoptions">Text body parser</a></p></li>
<li><p><a class="reference external" href="#bodyparserurlencodedoptions">URL-encoded form body parser</a></p></li>
</ul>
...
<div class="highlight-sh notranslate"><div class="highlight"><pre><span></span>$ npm install body-parser
</pre></div>
</div>
</div>
...
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="kd">var</span> <span class="nx">bodyParser</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;body-parser&#39;</span><span class="p">)</span>
</pre></div>
</div>
...
<a class="reference external" href="#errors">errors section</a>.</p>
<div class="section" id="bodyparser-json-options">
<h3>bodyParser.json([options])<a class="headerlink" href="#bodyparser-json-options" title="Permalink to this headline">¶</a></h3>
...
<div class="section" id="inflate">
<h5>inflate<a class="headerlink" href="#inflate" title="Permalink to this headline">¶</a></h5>
...
<h5>limit<a class="headerlink" href="#limit" title="Permalink to this headline">¶</a></h5>
...
<div class="section" id="reviver">
<h5>reviver<a class="headerlink" href="#reviver" title="Permalink to this headline">¶</a></h5>
...
<h5>strict<a class="headerlink" href="#strict" title="Permalink to this headline">¶</a></h5>
...
<h5>verify<a class="headerlink" href="#verify" title="Permalink to this headline">¶</a></h5>
...
<div class="section" id="bodyparser-raw-options">
<h3>bodyParser.raw([options])<a class="headerlink" href="#bodyparser-raw-options" title="Permalink to this headline">¶</a></h3>
...
<h5>inflate<a class="headerlink" href="#id2" title="Permalink to this headline">¶</a></h5>
<p>When set to <code class="docutils literal notranslate"><span class="pre">true</span></code>, then deflated (compressed) bodies will be inflated; when
<code class="docutils literal notranslate"><span class="pre">false</span></code>, deflated bodies are rejected. Defaults to <code class="docutils literal notranslate"><span class="pre">true</span></code>.</p>
</div>
<div class="section" id="id3">
<h5>limit<a class="headerlink" href="#id3" title="Permalink to this headline">¶</a></h5>
<p>Controls the maximum request body size. If this is a number, then the value
specifies the number of bytes; if it is a string, the value is passed to the
<a class="reference external" href="https://www.npmjs.com/package/bytes">bytes</a> library for parsing. Defaults
to <code class="docutils literal notranslate"><span class="pre">'100kb'</span></code>.</p>
...
<h5>verify<a class="headerlink" href="#id5" title="Permalink to this headline">¶</a></h5>
<p>The <code class="docutils literal notranslate"><span class="pre">verify</span></code> option, if supplied, is called as <code class="docutils literal notranslate"><span class="pre">verify(req,</span> <span class="pre">res,</span> <span class="pre">buf,</span> <span class="pre">encoding)</span></code>,
where <code class="docutils literal notranslate"><span class="pre">buf</span></code> is a <code class="docutils literal notranslate"><span class="pre">Buffer</span></code> of the raw request body and <code class="docutils literal notranslate"><span class="pre">encoding</span></code> is the
encoding of the request. The parsing can be aborted by throwing an error.</p>
</div>
...
<div class="section" id="bodyparser-text-options">
<h3>bodyParser.text([options])<a class="headerlink" href="#bodyparser-text-options" title="Permalink to this headline">¶</a></h3>
...
the following keys:</p>
<div class="section" id="defaultcharset">
<h5>defaultCharset<a class="headerlink" href="#defaultcharset" title="Permalink to this headline">¶</a></h5>
...
<h5>inflate<a class="headerlink" href="#id7" title="Permalink to this headline">¶</a></h5>
<p>When set to <code class="docutils literal notranslate"><span class="pre">true</span></code>, then deflated (compressed) bodies will be inflated; when
<code class="docutils literal notranslate"><span class="pre">false</span></code>, deflated bodies are rejected. Defaults to <code class="docutils literal notranslate"><span class="pre">true</span></code>.</p>
</div>
<div class="section" id="id8">
<h5>limit<a class="headerlink" href="#id8" title="Permalink to this headline">¶</a></h5>
<p>Controls the maximum request body size. If this is a number, then the value
specifies the number of bytes; if it is a string, the value is passed to the
<a class="reference external" href="https://www.npmjs.com/package/bytes">bytes</a> library for parsing. Defaults
to <code class="docutils literal notranslate"><span class="pre">'100kb'</span></code>.</p>
...
<h5>type<a class="headerlink" href="#id9" title="Permalink to this headline">¶</a></h5>
<p>The <code class="docutils literal notranslate"><span class="pre">type</span></code> option is used to determine what media type the middleware will
...
<h5>verify<a class="headerlink" href="#id10" title="Permalink to this headline">¶</a></h5>
<p>The <code class="docutils literal notranslate"><span class="pre">verify</span></code> option, if supplied, is called as <code class="docutils literal notranslate"><span class="pre">verify(req,</span> <span class="pre">res,</span> <span class="pre">buf,</span> <span class="pre">encoding)</span></code>,
where <code class="docutils literal notranslate"><span class="pre">buf</span></code> is a <code class="docutils literal notranslate"><span class="pre">Buffer</span></code> of the raw request body and <code class="docutils literal notranslate"><span class="pre">encoding</span></code> is the
encoding of the request. The parsing can be aborted by throwing an error.</p>
</div>
...
<div class="section" id="bodyparser-urlencoded-options">
<h3>bodyParser.urlencoded([options])<a class="headerlink" href="#bodyparser-urlencoded-options" title="Permalink to this headline">¶</a></h3>
...
<h5>extended<a class="headerlink" href="#extended" title="Permalink to this headline">¶</a></h5>
...
<h5>inflate<a class="headerlink" href="#id12" title="Permalink to this headline">¶</a></h5>
<p>When set to <code class="docutils literal notranslate"><span class="pre">true</span></code>, then deflated (compressed) bodies will be inflated; when
<code class="docutils literal notranslate"><span class="pre">false</span></code>, deflated bodies are rejected. Defaults to <code class="docutils literal notranslate"><span class="pre">true</span></code>.</p>
</div>
<div class="section" id="id13">
<h5>limit<a class="headerlink" href="#id13" title="Permalink to this headline">¶</a></h5>
<p>Controls the maximum request body size. If this is a number, then the value
specifies the number of bytes; if it is a string, the value is passed to the
<a class="reference external" href="https://www.npmjs.com/package/bytes">bytes</a> library for parsing. Defaults
to <code class="docutils literal notranslate"><span class="pre">'100kb'</span></code>.</p>
</div>
<div class="section" id="parameterlimit">
<h5>parameterLimit<a class="headerlink" href="#parameterlimit" title="Permalink to this headline">¶</a></h5>
...
<h5>type<a class="headerlink" href="#id14" title="Permalink to this headline">¶</a></h5>
<p>The <code class="docutils literal notranslate"><span class="pre">type</span></code> option is used to determine what media type the middleware will
parse. This option can be a string, array of strings, or a function. If not
a function, <code class="docutils literal notranslate"><span class="pre">type</span></code> option is passed directly to the
<a class="reference external" href="https://www.npmjs.org/package/type-is#readme">type-is</a> library and this can
...
<h5>verify<a class="headerlink" href="#id15" title="Permalink to this headline">¶</a></h5>
<p>The <code class="docutils literal notranslate"><span class="pre">verify</span></code> option, if supplied, is called as <code class="docutils literal notranslate"><span class="pre">verify(req,</span> <span class="pre">res,</span> <span class="pre">buf,</span> <span class="pre">encoding)</span></code>,
where <code class="docutils literal notranslate"><span class="pre">buf</span></code> is a <code class="docutils literal notranslate"><span class="pre">Buffer</span></code> of the raw request body and <code class="docutils literal notranslate"><span class="pre">encoding</span></code> is the
encoding of the request. The parsing can be aborted by throwing an error.</p>
</div>
...
<div class="section" id="content-encoding-unsupported">
<h3>content encoding unsupported<a class="headerlink" href="#content-encoding-unsupported" title="Permalink to this headline">¶</a></h3>
...
<div class="section" id="request-aborted">
<h3>request aborted<a class="headerlink" href="#request-aborted" title="Permalink to this headline">¶</a></h3>
...
<h3>request entity too large<a class="headerlink" href="#request-entity-too-large" title="Permalink to this headline">¶</a></h3>
...
<div class="section" id="request-size-did-not-match-content-length">
<h3>request size did not match content length<a class="headerlink" href="#request-size-did-not-match-content-length" title="Permalink to this headline">¶</a></h3>
...
<div class="section" id="stream-encoding-should-not-be-set">
<h3>stream encoding should not be set<a class="headerlink" href="#stream-encoding-should-not-be-set" title="Permalink to this headline">¶</a></h3>
...
<h3>too many parameters<a class="headerlink" href="#too-many-parameters" title="Permalink to this headline">¶</a></h3>
...
<div class="section" id="unsupported-charset-bogus">
<h3>unsupported charset “BOGUS”<a class="headerlink" href="#unsupported-charset-bogus" title="Permalink to this headline">¶</a></h3>
...
<div class="section" id="unsupported-content-encoding-bogus">
<h3>unsupported content encoding “bogus”<a class="headerlink" href="#unsupported-content-encoding-bogus" title="Permalink to this headline">¶</a></h3>
<p>This error will occur when the request had a <code class="docutils literal notranslate"><span class="pre">Content-Encoding</span></code> header that
...
<div class="section" id="express-connect-top-level-generic">
<h3>Express/Connect top-level generic<a class="headerlink" href="#express-connect-top-level-generic" title="Permalink to this headline">¶</a></h3>
...
<span class="nx">app</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span><span class="kd">function</span> <span class="p">(</span><span class="nx">req</span><span class="p">,</span> <span class="nx">res</span><span class="p">)</span> <span class="p">{</span>
  ...
  <span class="nx">res</span><span class="p">.</span><span class="nx">write</span><span class="p">(</span><span class="s1">&#39;you posted:\n&#39;</span><span class="p">)</span>
  <span class="nx">res</span><span class="p">.</span><span class="nx">end</span><span class="p">(</span><span class="nx">JSON</span><span class="p">.</span><span class="nx">stringify</span><span class="p">(</span><span class="nx">req</span><span class="p">.</span><span class="nx">body</span><span class="p">,</span> <span class="kc">null</span><span class="p">,</span> <span class="mi">2</span><span class="p">))</span>
<span class="p">})</span>
</pre></div>
</div>
</div>
<div class="section" id="express-route-specific">
<h3>Express route-specific<a class="headerlink" href="#express-route-specific" title="Permalink to this headline">¶</a></h3>
...
<span class="kd">var</span> <span class="nx">jsonParser</span> <span class="o">=</span> <span class="nx">bodyParser</span><span class="p">.</span><span class="nx">json</span><span class="p">()</span>
...
<span class="nx">app</span><span class="p">.</span><span class="nx">post</span><span class="p">(</span><span class="s1">&#39;/login&#39;</span><span class="p">,</span> <span class="nx">urlencodedParser</span><span class="p">,</span> <span class="kd">function</span> <span class="p">(</span><span class="nx">req</span><span class="p">,</span> <span class="nx">res</span><span class="p">)</span> <span class="p">{</span>
  <span class="nx">res</span><span class="p">.</span><span class="nx">send</span><span class="p">(</span><span class="s1">&#39;welcome, &#39;</span> <span class="o">+</span> <span class="nx">req</span><span class="p">.</span><span class="nx">body</span><span class="p">.</span><span class="nx">username</span><span class="p">)</span>
<span class="p">})</span>

<span class="c1">// POST /api/users gets JSON bodies</span>
<span class="nx">app</span><span class="p">.</span><span class="nx">post</span><span class="p">(</span><span class="s1">&#39;/api/users&#39;</span><span class="p">,</span> <span class="nx">jsonParser</span><span class="p">,</span> <span class="kd">function</span> <span class="p">(</span><span class="nx">req</span><span class="p">,</span> <span class="nx">res</span><span class="p">)</span> <span class="p">{</span>
  <span class="c1">// create user in req.body</span>
<span class="p">})</span>
</pre></div>
</div>
</div>
<div class="section" id="change-accepted-type-for-parsers">
<h3>Change accepted type for parsers<a class="headerlink" href="#change-accepted-type-for-parsers" title="Permalink to this headline">¶</a></h3>
...
<span class="nx">app</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span><span class="nx">bodyParser</span><span class="p">.</span><span class="nx">json</span><span class="p">({</span> <span class="nx">type</span><span class="o">:</span> <span class="s1">&#39;application/*+json&#39;</span> <span class="p">}))</span>

<span class="c1">// parse some custom thing into a Buffer</span>
<span class="nx">app</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span><span class="nx">bodyParser</span><span class="p">.</span><span class="nx">raw</span><span class="p">({</span> <span class="nx">type</span><span class="o">:</span> <span class="s1">&#39;application/vnd.custom-type&#39;</span> <span class="p">}))</span>

<span class="c1">// parse an HTML body into a string</span>
<span class="nx">app</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span><span class="nx">bodyParser</span><span class="p">.</span><span class="nx">text</span><span class="p">({</span> <span class="nx">type</span><span class="o">:</span> <span class="s1">&#39;text/html&#39;</span> <span class="p">}))</span>
</pre></div>
</div>
</div>
</div>
...
<p><span class="xref myst">MIT</span></p>
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            kernelName: "python3",
            path: "./.cache/yarn/v6/npm-body-parser-1.19.0-96b2709e57c9c4e09a6fd66a8fd979844f69f08a-integrity/node_modules/body-parser"
        },
