...
<html>
  <head>
    ...
    <title>minipass &#8212; Colab Experiment</title>
...
<div class="dropdown-buttons-trigger">
    ...
    <div class="dropdown-buttons sourcebuttons">
        ...
        <a class="issues-button"
            href="https://github.com/fm75/jbook-209/issues/new?title=Issue%20on%20page%20%2F.cache/yarn/v6/npm-minipass-3.1.3-7d42ff1f39635482e15f9cdb53184deebd5815fd-integrity/node_modules/minipass/README.html&body=Your%20issue%20content%20here."><button
                type="button" class="btn btn-secondary topbarbtn" data-toggle="tooltip" data-placement="left"
                title="Open an issue"><i class="fas fa-lightbulb"></i>open issue</button></a>
        <a class="edit-button" href="https://github.com/fm75/jbook-209/edit/master/.cache/yarn/v6/npm-minipass-3.1.3-7d42ff1f39635482e15f9cdb53184deebd5815fd-integrity/node_modules/minipass/README.md"><button
                type="button" class="btn btn-secondary topbarbtn" data-toggle="tooltip" data-placement="left"
...
<span class="kr">const</span> <span class="nx">p1</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">PassThrough</span><span class="p">({</span> <span class="nx">highWaterMark</span><span class="o">:</span> <span class="mi">1024</span> <span class="p">})</span>
<span class="kr">const</span> <span class="nx">p2</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">PassThrough</span><span class="p">({</span> <span class="nx">highWaterMark</span><span class="o">:</span> <span class="mi">1024</span> <span class="p">})</span>
<span class="kr">const</span> <span class="nx">p3</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">PassThrough</span><span class="p">({</span> <span class="nx">highWaterMark</span><span class="o">:</span> <span class="mi">1024</span> <span class="p">})</span>
<span class="kr">const</span> <span class="nx">p4</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">PassThrough</span><span class="p">({</span> <span class="nx">highWaterMark</span><span class="o">:</span> <span class="mi">1024</span> <span class="p">})</span>
...
<span class="nx">p1</span><span class="p">.</span><span class="nx">write</span><span class="p">(</span><span class="nx">Buffer</span><span class="p">.</span><span class="nx">alloc</span><span class="p">(</span><span class="mi">2048</span><span class="p">))</span> <span class="c1">// returns false</span>
</pre></div>
</div>
...
<span class="nx">m1</span><span class="p">.</span><span class="nx">write</span><span class="p">(</span><span class="nx">Buffer</span><span class="p">.</span><span class="nx">alloc</span><span class="p">(</span><span class="mi">2048</span><span class="p">))</span> <span class="c1">// returns true</span>
</pre></div>
</div>
...
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="kr">class</span> <span class="nx">NDJSONDecode</span> <span class="kr">extends</span> <span class="nx">Minipass</span> <span class="p">{</span>
  ...
  <span class="nx">write</span> <span class="p">(</span><span class="nx">chunk</span><span class="p">,</span> <span class="nx">encoding</span><span class="p">,</span> <span class="nx">cb</span><span class="p">)</span> <span class="p">{</span>
    ...
    <span class="k">for</span> <span class="p">(</span><span class="kd">let</span> <span class="nx">i</span> <span class="o">=</span> <span class="mi">0</span><span class="p">;</span> <span class="nx">i</span> <span class="o">&lt;</span> <span class="nx">jsonData</span><span class="p">.</span><span class="nx">length</span><span class="p">;</span> <span class="nx">i</span><span class="o">++</span><span class="p">)</span> <span class="p">{</span>
