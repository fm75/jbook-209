...
<html>
  <head>
    ...
    <title>Table of Contents &#8212; Colab Experiment</title>
...
<main class="col py-md-3 pl-md-4 bd-content overflow-auto" role="main">
    ...
    <div class="dropdown-buttons">
        ...
        <!-- Download raw file -->
        <a class="dropdown-buttons" href="../../../../../../_sources/.cache/yarn/v6/npm-webpack-4.43.0-c48547b11d563224c561dad1172c8aa0b8a678e6-integrity/node_modules/webpack/README.md"><button type="button"
...
<div class="dropdown-buttons-trigger">
    ...
    <div class="dropdown-buttons sourcebuttons">
        ...
        <a class="issues-button"
            href="https://github.com/fm75/jbook-209/issues/new?title=Issue%20on%20page%20%2F.cache/yarn/v6/npm-webpack-4.43.0-c48547b11d563224c561dad1172c8aa0b8a678e6-integrity/node_modules/webpack/README.html&body=Your%20issue%20content%20here."><button
                type="button" class="btn btn-secondary topbarbtn" data-toggle="tooltip" data-placement="left"
                title="Open an issue"><i class="fas fa-lightbulb"></i>open issue</button></a>
        <a class="edit-button" href="https://github.com/fm75/jbook-209/edit/master/.cache/yarn/v6/npm-webpack-4.43.0-c48547b11d563224c561dad1172c8aa0b8a678e6-integrity/node_modules/webpack/README.md"><button
                type="button" class="btn btn-secondary topbarbtn" data-toggle="tooltip" data-placement="left"
 ...
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#browser-compatibility">
 ...
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#loaders">
   Loaders
  </a>
  <ul class="nav section-nav flex-column">
   ...
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#transpiling">
     Transpiling
    </a>
   </li>
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#templating">
     Templating
    </a>
   </li>
   <li class="toc-h3 nav-item toc-entry">
   ...
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#linting-testing">
     Linting &amp; Testing
    </a>
   </li>
   <li class="toc-h3 nav-item toc-entry">
 ...
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#module-formats">
   Module Formats
  </a>
 </li>
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#code-splitting">
   Code Splitting
  </a>
 </li>
 <li class="toc-h2 nav-item toc-entry">
 ...
 <li class="toc-h2 nav-item toc-entry">
  ...
  <br>
  <br>
<p><a class="reference external" href="https://npmjs.com/package/webpack"><img alt="npm" src="https://img.shields.io/npm/v/webpack.svg" /></a></p>
<p><a class="reference external" href="https://nodejs.org"><img alt="node" src="https://img.shields.io/node/v/webpack.svg" /></a>
<a class="reference external" href="https://david-dm.org/webpack/webpack"><img alt="deps" src="https://img.shields.io/david/webpack/webpack.svg" /></a>
<a class="reference external" href="https://travis-ci.org/webpack/webpack"><img alt="tests" src="https://img.shields.io/travis/webpack/webpack/master.svg" /></a>
<a class="reference external" href="https://ci.appveyor.com/project/sokra/webpack/branch/master"><img alt="builds" src="https://ci.appveyor.com/api/projects/status/github/webpack/webpack?svg=true" /></a>
<a class="reference external" href="https://dev.azure.com/webpack/webpack/_build/latest?definitionId=3"><img alt="builds2" src="https://dev.azure.com/webpack/webpack/_apis/build/status/webpack.webpack" /></a>
<a class="reference external" href="https://coveralls.io/r/webpack/webpack/"><img alt="coverage" src="https://img.shields.io/coveralls/webpack/webpack.svg" /></a>
<a class="reference external" href="https://app.fossa.io/projects/git%2Bhttps%3A%2F%2Fgithub.com%2Fwebpack%2Fwebpack?ref=badge_shield"><img alt="licenses" src="https://app.fossa.io/api/projects/git%2Bhttps%3A%2F%2Fgithub.com%2Fwebpack%2Fwebpack.svg?type=shield" /></a>
<a class="reference external" href="https://webpack.js.org/contribute/"><img alt="PR's welcome" src="https://img.shields.io/badge/PRs-welcome-brightgreen.svg" /></a></p>
  <br>
...
<li><p><a class="reference external" href="#concepts">Concepts</a></p></li>
...
<li><p><a class="reference external" href="#core-team">Core Team</a></p></li>
<li><p><a class="reference external" href="#sponsoring">Sponsoring</a></p></li>
<li><p><a class="reference external" href="#premium-partners">Premium Partners</a></p></li>
<li><p><a class="reference external" href="#other-backers-and-sponsors">Other Backers and Sponsors</a></p></li>
<li><p><a class="reference external" href="#gold-sponsors">Gold Sponsors</a></p></li>
<li><p><a class="reference external" href="#silver-sponsors">Silver Sponsors</a></p></li>
<li><p><a class="reference external" href="#bronze-sponsors">Bronze Sponsors</a></p></li>
<li><p><a class="reference external" href="#backers">Backers</a></p></li>
<li><p><a class="reference external" href="#special-thanks-to">Special Thanks</a></p></li>
</ol>
<h2 align="center">Install</h2>
<p>Install with npm:</p>
<div class="highlight-bash notranslate"><div class="highlight"><pre><span></span>npm install --save-dev webpack
</pre></div>
</div>
<p>Install with yarn:</p>
<div class="highlight-bash notranslate"><div class="highlight"><pre><span></span>yarn add webpack --dev
</pre></div>
</div>
...
<ul class="simple">
<li><p>Bundles <a class="reference external" href="http://www.2ality.com/2014/09/es6-modules-final.html">ES Modules</a>, <a class="reference external" href="http://wiki.commonjs.org/">CommonJS</a>, and <a class="reference external" href="https://github.com/amdjs/amdjs-api/wiki/AMD">AMD</a> modules (even combined).</p></li>
<li><p>Can create a single bundle or multiple chunks that are asynchronously loaded at runtime (to reduce initial loading time).</p></li>
<li><p>Dependencies are resolved during compilation, reducing the runtime size.</p></li>
<li><p>Loaders can preprocess files while compiling, e.g. TypeScript to JavaScript, Handlebars strings to compiled functions, images to Base64, etc.</p></li>
<li><p>Highly modular plugin system to do whatever else your application requires.</p></li>
</ul>
<div class="section" id="get-started">
<h2>Get Started<a class="headerlink" href="#get-started" title="Permalink to this headline">¶</a></h2>
<p>Check out webpack’s quick <a class="reference external" href="https://webpack.js.org/guides/getting-started"><strong>Get Started</strong></a> guide and the <a class="reference external" href="https://webpack.js.org/guides/">other guides</a>.</p>
</div>
...
<p>webpack supports all browsers that are <a class="reference external" href="http://kangax.github.io/compat-table/es5/">ES5-compliant</a> (IE8 and below are not supported).
webpack also needs <code class="docutils literal notranslate"><span class="pre">Promise</span></code> for <code class="docutils literal notranslate"><span class="pre">import()</span></code> and <code class="docutils literal notranslate"><span class="pre">require.ensure()</span></code>. If you want to support older browsers, you will need to <a class="reference external" href="https://webpack.js.org/guides/shimming/">load a polyfill</a> before using these expressions.</p>
<h2 align="center">Concepts</h2>
</div>
<div class="section" id="plugins">
<h2><a class="reference external" href="https://webpack.js.org/plugins/">Plugins</a><a class="headerlink" href="#plugins" title="Permalink to this headline">¶</a></h2>
<p>webpack has a <a class="reference external" href="https://webpack.js.org/plugins/">rich plugin
...
<th class="text-align:center head"><p>Install Size</p></th>
<th class="text-align:left head"><p>Description</p></th>
</tr>
</thead>
<tbody>
<tr class="row-even"><td class="text-align:center"><p><a class="reference external" href="https://github.com/webpack-contrib/mini-css-extract-plugin">mini-css-extract-plugin</a></p></td>
<td class="text-align:center"><p><img alt="mini-css-npm" src="https://img.shields.io/npm/v/mini-css-extract-plugin.svg" /></p></td>
<td class="text-align:center"><p><img alt="mini-css-size" src="https://packagephobia.now.sh/badge?p=mini-css-extract-plugin" /></p></td>
<td class="text-align:left"><p>Extracts CSS into separate files. It creates a CSS file per JS file which contains CSS.</p></td>
</tr>
<tr class="row-odd"><td class="text-align:center"><p><a class="reference external" href="https://github.com/webpack/compression-webpack-plugin">compression-webpack-plugin</a></p></td>
<td class="text-align:center"><p><img alt="compression-npm" src="https://img.shields.io/npm/v/compression-webpack-plugin.svg" /></p></td>
<td class="text-align:center"><p><img alt="compression-size" src="https://packagephobia.now.sh/badge?p=compression-webpack-plugin" /></p></td>
<td class="text-align:left"><p>Prepares compressed versions of assets to serve them with Content-Encoding</p></td>
</tr>
<tr class="row-even"><td class="text-align:center"><p><a class="reference external" href="https://github.com/webpack/i18n-webpack-plugin">i18n-webpack-plugin</a></p></td>
<td class="text-align:center"><p><img alt="i18n-npm" src="https://img.shields.io/npm/v/i18n-webpack-plugin.svg" /></p></td>
<td class="text-align:center"><p><img alt="i18n-size" src="https://packagephobia.now.sh/badge?p=i18n-webpack-plugin" /></p></td>
<td class="text-align:left"><p>Adds i18n support to your bundles</p></td>
</tr>
<tr class="row-odd"><td class="text-align:center"><p><a class="reference external" href="https://github.com/ampedandwired/html-webpack-plugin">html-webpack-plugin</a></p></td>
<td class="text-align:center"><p><img alt="html-plugin-npm" src="https://img.shields.io/npm/v/html-webpack-plugin.svg" /></p></td>
<td class="text-align:center"><p><img alt="html-plugin-size" src="https://packagephobia.now.sh/badge?p=html-webpack-plugin" /></p></td>
<td class="text-align:left"><p>Simplifies creation of HTML files (<code class="docutils literal notranslate"><span class="pre">index.html</span></code>) to serve your bundles</p></td>
</tr>
<tr class="row-even"><td class="text-align:center"><p><a class="reference external" href="https://github.com/webpack/extract-text-webpack-plugin">extract-text-webpack-plugin</a></p></td>
<td class="text-align:center"><p><img alt="extract-npm" src="https://img.shields.io/npm/v/extract-text-webpack-plugin.svg" /></p></td>
<td class="text-align:center"><p><img alt="extract-size" src="https://packagephobia.now.sh/badge?p=extract-text-webpack-plugin" /></p></td>
<td class="text-align:left"><p>Extract text from a bundle, or bundles, into a separate file</p></td>
</tr>
</tbody>
</table>
</div>
<div class="section" id="loaders">
<h2><a class="reference external" href="https://webpack.js.org/loaders/">Loaders</a><a class="headerlink" href="#loaders" title="Permalink to this headline">¶</a></h2>
<p>webpack enables use of loaders to preprocess files. This allows you to bundle
<strong>any static resource</strong> way beyond JavaScript. You can easily <a class="reference external" href="https://webpack.js.org/api/loaders/">write your own
loaders</a> using Node.js.</p>
<p>Loaders are activated by using <code class="docutils literal notranslate"><span class="pre">loadername!</span></code> prefixes in <code class="docutils literal notranslate"><span class="pre">require()</span></code> statements,
...
<tbody>
<tr class="row-even"><td class="text-align:center"><p><a class="reference external" href="https://github.com/webpack/raw-loader">raw-loader</a></p></td>
<td class="text-align:center"><p><img alt="raw-npm" src="https://img.shields.io/npm/v/raw-loader.svg" /></p></td>
<td class="text-align:center"><p><img alt="raw-size" src="https://packagephobia.now.sh/badge?p=raw-loader" /></p></td>
<td class="text-align:left"><p>Loads raw content of a file (utf-8)</p></td>
</tr>
<tr class="row-odd"><td class="text-align:center"><p><a class="reference external" href="https://github.com/webpack/val-loader">val-loader</a></p></td>
<td class="text-align:center"><p><img alt="val-npm" src="https://img.shields.io/npm/v/val-loader.svg" /></p></td>
<td class="text-align:center"><p><img alt="val-size" src="https://packagephobia.now.sh/badge?p=val-loader" /></p></td>
<td class="text-align:left"><p>Executes code as module and considers exports as JS code</p></td>
</tr>
<tr class="row-even"><td class="text-align:center"><p><a class="reference external" href="https://github.com/webpack/url-loader">url-loader</a></p></td>
<td class="text-align:center"><p><img alt="url-npm" src="https://img.shields.io/npm/v/url-loader.svg" /></p></td>
<td class="text-align:center"><p><img alt="url-size" src="https://packagephobia.now.sh/badge?p=url-loader" /></p></td>
<td class="text-align:left"><p>Works like the file loader, but can return a Data Url if the file is smaller than a limit</p></td>
</tr>
<tr class="row-odd"><td class="text-align:center"><p><a class="reference external" href="https://github.com/webpack/file-loader">file-loader</a></p></td>
<td class="text-align:center"><p><img alt="file-npm" src="https://img.shields.io/npm/v/file-loader.svg" /></p></td>
<td class="text-align:center"><p><img alt="file-size" src="https://packagephobia.now.sh/badge?p=file-loader" /></p></td>
<td class="text-align:left"><p>Emits the file into the output folder and returns the (relative) url</p></td>
</tr>
</tbody>
</table>
</div>
...
<tbody>
<tr class="row-even"><td class="text-align:center"><p><a href="https://github.com/webpack/json-loader"><img width="48" height="48" src="https://worldvectorlogo.com/logos/json.svg"></a></p></td>
<td class="text-align:center"><p><img alt="json-npm" src="https://img.shields.io/npm/v/json-loader.svg" /></p></td>
<td class="text-align:center"><p><img alt="json-size" src="https://packagephobia.now.sh/badge?p=json-loader" /></p></td>
<td class="text-align:left"><p>Loads a JSON file (included by default)</p></td>
</tr>
<tr class="row-odd"><td class="text-align:center"><p><a href="https://github.com/webpack/json5-loader"><img width="48" height="10.656" src="https://cdn.rawgit.com/json5/json5-logo/master/json5-logo.svg"></a></p></td>
<td class="text-align:center"><p><img alt="json5-npm" src="https://img.shields.io/npm/v/json5-loader.svg" /></p></td>
<td class="text-align:center"><p><img alt="json5-size" src="https://packagephobia.now.sh/badge?p=json5-loader" /></p></td>
<td class="text-align:left"><p>Loads and transpiles a JSON 5 file</p></td>
</tr>
<tr class="row-even"><td class="text-align:center"><p><a href="https://github.com/awnist/cson-loader"><img width="48" height="48" src="https://worldvectorlogo.com/logos/coffeescript.svg"></a></p></td>
<td class="text-align:center"><p><img alt="cson-npm" src="https://img.shields.io/npm/v/cson-loader.svg" /></p></td>
<td class="text-align:center"><p><img alt="cson-size" src="https://packagephobia.now.sh/badge?p=cson-loader" /></p></td>
<td class="text-align:left"><p>Loads and transpiles a CSON file</p></td>
</tr>
</tbody>
</table>
</div>
<div class="section" id="transpiling">
<h3>Transpiling<a class="headerlink" href="#transpiling" title="Permalink to this headline">¶</a></h3>
<table class="colwidths-auto table">
<thead>
<tr class="row-odd"><th class="text-align:center head"><p>Name</p></th>
<th class="text-align:center head"><p>Status</p></th>
...
<tbody>
<tr class="row-even"><td class="text-align:center"><p><a href="https://github.com/webpack/script-loader"><code class="docutils literal notranslate"><span class="pre">&lt;script&gt;</span></code></a></p></td>
<td class="text-align:center"><p><img alt="script-npm" src="https://img.shields.io/npm/v/script-loader.svg" /></p></td>
<td class="text-align:center"><p><img alt="script-size" src="https://packagephobia.now.sh/badge?p=script-loader" /></p></td>
<td class="text-align:left"><p>Executes a JavaScript file once in global context (like in script tag), <code class="docutils literal notranslate"><span class="pre">require()</span></code>s are not parsed</p></td>
</tr>
<tr class="row-odd"><td class="text-align:center"><p><a href="https://github.com/babel/babel-loader"><img width="48" height="48" title="babel-loader" src="https://worldvectorlogo.com/logos/babel-10.svg"></a></p></td>
<td class="text-align:center"><p><img alt="babel-npm" src="https://img.shields.io/npm/v/babel-loader.svg" /></p></td>
<td class="text-align:center"><p><img alt="babel-size" src="https://packagephobia.now.sh/badge?p=babel-loader" /></p></td>
<td class="text-align:left"><p>Loads ES2015+ code and transpiles to ES5 using <a href="https://github.com/babel/babel">Babel</a></p></td>
</tr>
<tr class="row-even"><td class="text-align:center"><p><a href="https://github.com/jupl/traceur-loader"><img width="48" height="48" src="https://google.github.com/traceur-compiler/logo/tc.svg"></a></p></td>
<td class="text-align:center"><p><img alt="traceur-npm" src="https://img.shields.io/npm/v/traceur-loader.svg" /></p></td>
<td class="text-align:center"><p><img alt="traceur-size" src="https://packagephobia.now.sh/badge?p=traceur-loader" /></p></td>
<td class="text-align:left"><p>Loads ES2015+ code and transpiles to ES5 using <a class="reference external" href="https://github.com/google/traceur-compiler">Traceur</a></p></td>
</tr>
<tr class="row-odd"><td class="text-align:center"><p><a href="https://github.com/TypeStrong/ts-loader"><img width="48" height="48" src="https://cdn.rawgit.com/Microsoft/TypeScript/master/doc/logo.svg"></a></p></td>
<td class="text-align:center"><p><img alt="type-npm" src="https://img.shields.io/npm/v/ts-loader.svg" /></p></td>
<td class="text-align:center"><p><img alt="type-size" src="https://packagephobia.now.sh/badge?p=ts-loader" /></p></td>
<td class="text-align:left"><p>Loads TypeScript like JavaScript</p></td>
</tr>
<tr class="row-even"><td class="text-align:center"><p><a class="reference external" href="https://github.com/s-panferov/awesome-typescript-loader"><code class="docutils literal notranslate"><span class="pre">awesome-typescript-loader</span></code></a></p></td>
<td class="text-align:center"><p><img alt="awesome-typescript-npm" src="https://img.shields.io/npm/v/awesome-typescript-loader.svg" /></p></td>
<td class="text-align:center"><p><img alt="awesome-typescript-size" src="https://packagephobia.now.sh/badge?p=awesome-typescript-loader" /></p></td>
<td class="text-align:left"><p>Awesome TypeScript loader for webpack</p></td>
</tr>
<tr class="row-odd"><td class="text-align:center"><p><a href="https://github.com/webpack/coffee-loader"><img width="48" height="48" src="https://worldvectorlogo.com/logos/coffeescript.svg"></a></p></td>
<td class="text-align:center"><p><img alt="coffee-npm" src="https://img.shields.io/npm/v/coffee-loader.svg" /></p></td>
<td class="text-align:center"><p><img alt="coffee-size" src="https://packagephobia.now.sh/badge?p=coffee-loader" /></p></td>
<td class="text-align:left"><p>Loads CoffeeScript like JavaScript</p></td>
</tr>
</tbody>
</table>
</div>
...
<tbody>
<tr class="row-even"><td class="text-align:center"><p><a href="https://github.com/webpack/html-loader"><img width="48" height="48" src="https://worldvectorlogo.com/logos/html5.svg"></a></p></td>
<td class="text-align:center"><p><img alt="html-npm" src="https://img.shields.io/npm/v/html-loader.svg" /></p></td>
<td class="text-align:center"><p><img alt="html-size" src="https://packagephobia.now.sh/badge?p=html-loader" /></p></td>
<td class="text-align:left"><p>Exports HTML as string, requires references to static resources</p></td>
</tr>
<tr class="row-odd"><td class="text-align:center"><p><a href="https://github.com/pugjs/pug-loader"><img width="48" height="48" src="https://cdn.rawgit.com/pugjs/pug-logo/master/SVG/pug-final-logo-_-colour-128.svg"></a></p></td>
<td class="text-align:center"><p><img alt="pug-npm" src="https://img.shields.io/npm/v/pug-loader.svg" /></p></td>
<td class="text-align:center"><p><img alt="pug-size" src="https://packagephobia.now.sh/badge?p=pug-loader" /></p></td>
<td class="text-align:left"><p>Loads Pug templates and returns a function</p></td>
</tr>
<tr class="row-even"><td class="text-align:center"><p><a href="https://github.com/webpack/jade-loader"><img width="48" height="48" src="https://worldvectorlogo.com/logos/jade-3.svg"></a></p></td>
<td class="text-align:center"><p><img alt="jade-npm" src="https://img.shields.io/npm/v/jade-loader.svg" /></p></td>
<td class="text-align:center"><p><img alt="jade-size" src="https://packagephobia.now.sh/badge?p=jade-loader" /></p></td>
<td class="text-align:left"><p>Loads Jade templates and returns a function</p></td>
</tr>
<tr class="row-odd"><td class="text-align:center"><p><a href="https://github.com/peerigon/markdown-loader"><img width="48" height="48" src="https://worldvectorlogo.com/logos/markdown.svg"></a></p></td>
<td class="text-align:center"><p><img alt="md-npm" src="https://img.shields.io/npm/v/markdown-loader.svg" /></p></td>
<td class="text-align:center"><p><img alt="md-size" src="https://packagephobia.now.sh/badge?p=markdown-loader" /></p></td>
<td class="text-align:left"><p>Compiles Markdown to HTML</p></td>
</tr>
<tr class="row-even"><td class="text-align:center"><p><a href="https://github.com/posthtml/posthtml-loader"><img width="48" height="48" src="http://posthtml.github.io/posthtml/logo.svg"></a></p></td>
<td class="text-align:center"><p><img alt="posthtml-npm" src="https://img.shields.io/npm/v/posthtml-loader.svg" /></p></td>
<td class="text-align:center"><p><img alt="posthtml-size" src="https://packagephobia.now.sh/badge?p=posthtml-loader" /></p></td>
<td class="text-align:left"><p>Loads and transforms a HTML file using <a class="reference external" href="https://github.com/posthtml/posthtml">PostHTML</a></p></td>
</tr>
<tr class="row-odd"><td class="text-align:center"><p><a href="https://github.com/altano/handlebars-loader"><img width="48" height="48" src="https://worldvectorlogo.com/logos/handlebars-1.svg"></a></p></td>
<td class="text-align:center"><p><img alt="hbs-npm" src="https://img.shields.io/npm/v/handlebars-loader.svg" /></p></td>
<td class="text-align:center"><p><img alt="hbs-size" src="https://packagephobia.now.sh/badge?p=handlebars-loader" /></p></td>
<td class="text-align:left"><p>Compiles Handlebars to HTML</p></td>
</tr>
</tbody>
</table>
</div>
...
<tbody>
<tr class="row-even"><td class="text-align:center"><p><a href="https://github.com/webpack/style-loader"><code class="docutils literal notranslate"><span class="pre">&lt;style&gt;</span></code></a></p></td>
<td class="text-align:center"><p><img alt="style-npm" src="https://img.shields.io/npm/v/style-loader.svg" /></p></td>
<td class="text-align:center"><p><img alt="style-size" src="https://packagephobia.now.sh/badge?p=style-loader" /></p></td>
<td class="text-align:left"><p>Add exports of a module as style to DOM</p></td>
</tr>
<tr class="row-odd"><td class="text-align:center"><p><a href="https://github.com/webpack/css-loader"><img width="48" height="48" src="https://worldvectorlogo.com/logos/css-3.svg"></a></p></td>
<td class="text-align:center"><p><img alt="css-npm" src="https://img.shields.io/npm/v/css-loader.svg" /></p></td>
<td class="text-align:center"><p><img alt="css-size" src="https://packagephobia.now.sh/badge?p=css-loader" /></p></td>
<td class="text-align:left"><p>Loads CSS file with resolved imports and returns CSS code</p></td>
</tr>
<tr class="row-even"><td class="text-align:center"><p><a href="https://github.com/webpack/less-loader"><img width="48" height="48" src="https://worldvectorlogo.com/logos/less-63.svg"></a></p></td>
<td class="text-align:center"><p><img alt="less-npm" src="https://img.shields.io/npm/v/less-loader.svg" /></p></td>
<td class="text-align:center"><p><img alt="less-size" src="https://packagephobia.now.sh/badge?p=less-loader" /></p></td>
<td class="text-align:left"><p>Loads and compiles a LESS file</p></td>
</tr>
<tr class="row-odd"><td class="text-align:center"><p><a href="https://github.com/jtangelder/sass-loader"><img width="48" height="48" src="https://worldvectorlogo.com/logos/sass-1.svg"></a></p></td>
<td class="text-align:center"><p><img alt="sass-npm" src="https://img.shields.io/npm/v/sass-loader.svg" /></p></td>
<td class="text-align:center"><p><img alt="sass-size" src="https://packagephobia.now.sh/badge?p=sass-loader" /></p></td>
<td class="text-align:left"><p>Loads and compiles a Sass/SCSS file</p></td>
</tr>
<tr class="row-even"><td class="text-align:center"><p><a href="https://github.com/shama/stylus-loader"><img width="48" height="48" src="https://worldvectorlogo.com/logos/stylus.svg"></a></p></td>
<td class="text-align:center"><p><img alt="stylus-npm" src="https://img.shields.io/npm/v/stylus-loader.svg" /></p></td>
<td class="text-align:center"><p><img alt="stylus-size" src="https://packagephobia.now.sh/badge?p=stylus-loader" /></p></td>
<td class="text-align:left"><p>Loads and compiles a Stylus file</p></td>
</tr>
<tr class="row-odd"><td class="text-align:center"><p><a href="https://github.com/postcss/postcss-loader"><img width="48" height="48" src="https://worldvectorlogo.com/logos/postcss.svg"></a></p></td>
<td class="text-align:center"><p><img alt="postcss-npm" src="https://img.shields.io/npm/v/postcss-loader.svg" /></p></td>
<td class="text-align:center"><p><img alt="postcss-size" src="https://packagephobia.now.sh/badge?p=postcss-loader" /></p></td>
<td class="text-align:left"><p>Loads and transforms a CSS/SSS file using <a class="reference external" href="http://postcss.org">PostCSS</a></p></td>
</tr>
</tbody>
</table>
</div>
<div class="section" id="linting-testing">
<h3>Linting &amp; Testing<a class="headerlink" href="#linting-testing" title="Permalink to this headline">¶</a></h3>
<table class="colwidths-auto table">
<thead>
<tr class="row-odd"><th class="text-align:center head"><p>Name</p></th>
<th class="text-align:center head"><p>Status</p></th>
...
<tbody>
<tr class="row-even"><td class="text-align:center"><p><a href="https://github.com/webpack/mocha-loader"><img width="48" height="48" src="https://worldvectorlogo.com/logos/mocha.svg"></a></p></td>
<td class="text-align:center"><p><img alt="mocha-npm" src="https://img.shields.io/npm/v/mocha-loader.svg" /></p></td>
<td class="text-align:center"><p><img alt="mocha-size" src="https://packagephobia.now.sh/badge?p=mocha-loader" /></p></td>
<td class="text-align:left"><p>Tests with mocha (Browser/NodeJS)</p></td>
</tr>
<tr class="row-odd"><td class="text-align:center"><p><a href="https://github.com/MoOx/eslint-loader"><img width="48" height="48" src="https://worldvectorlogo.com/logos/eslint.svg"></a></p></td>
<td class="text-align:center"><p><img alt="eslint-npm" src="https://img.shields.io/npm/v/eslint-loader.svg" /></p></td>
<td class="text-align:center"><p><img alt="eslint-size" src="https://packagephobia.now.sh/badge?p=eslint-loader" /></p></td>
<td class="text-align:left"><p>PreLoader for linting code using ESLint</p></td>
</tr>
<tr class="row-even"><td class="text-align:center"><p><a href="https://github.com/webpack-contrib/jshint-loader"><img width="48" height="20.64" src="http://jshint.com/res/jshint-dark.png"></a></p></td>
<td class="text-align:center"><p><img alt="jshint-npm" src="https://img.shields.io/npm/v/jshint-loader.svg" /></p></td>
<td class="text-align:center"><p><img alt="jshint-size" src="https://packagephobia.now.sh/badge?p=jshint-loader" /></p></td>
<td class="text-align:left"><p>PreLoader for linting code using JSHint</p></td>
</tr>
</tbody>
</table>
</div>
...
<tbody>
<tr class="row-even"><td class="text-align:center"><p><a href="https://github.com/vuejs/vue-loader"><img width="48" height="48" src="https://worldvectorlogo.com/logos/vue-9.svg"></a></p></td>
<td class="text-align:center"><p><img alt="vue-npm" src="https://img.shields.io/npm/v/vue-loader.svg" /></p></td>
<td class="text-align:center"><p><img alt="vue-size" src="https://packagephobia.now.sh/badge?p=vue-loader" /></p></td>
<td class="text-align:left"><p>Loads and compiles Vue Components</p></td>
</tr>
<tr class="row-odd"><td class="text-align:center"><p><a href="https://github.com/webpack-contrib/polymer-webpack-loader"><img width="48" height="48" src="https://worldvectorlogo.com/logos/polymer.svg"></a></p></td>
<td class="text-align:center"><p><img alt="polymer-npm" src="https://img.shields.io/npm/v/polymer-webpack-loader.svg" /></p></td>
<td class="text-align:center"><p><img alt="polymer-size" src="https://packagephobia.now.sh/badge?p=polymer-webpack-loader" /></p></td>
<td class="text-align:left"><p>Process HTML &amp; CSS with preprocessor of choice and <code class="docutils literal notranslate"><span class="pre">require()</span></code> Web Components like first-class modules</p></td>
</tr>
<tr class="row-even"><td class="text-align:center"><p><a href="https://github.com/TheLarkInn/angular2-template-loader"><img width="48" height="48" src="https://worldvectorlogo.com/logos/angular-icon-1.svg"></a></p></td>
<td class="text-align:center"><p><img alt="angular-npm" src="https://img.shields.io/npm/v/angular2-template-loader.svg" /></p></td>
<td class="text-align:center"><p><img alt="angular-size" src="https://packagephobia.now.sh/badge?p=angular2-template-loader" /></p></td>
<td class="text-align:left"><p>Loads and compiles Angular 2 Components</p></td>
</tr>
<tr class="row-odd"><td class="text-align:center"><p><a href="https://github.com/riot/tag-loader"><img width="48" height="48" src="https://worldvectorlogo.com/logos/riot.svg"></a></p></td>
<td class="text-align:center"><p><img alt="riot-npm" src="https://img.shields.io/npm/v/riot-tag-loader.svg" /></p></td>
<td class="text-align:center"><p><img alt="riot-size" src="https://packagephobia.now.sh/badge?p=riot-tag-loader" /></p></td>
<td class="text-align:left"><p>Riot official webpack loader</p></td>
</tr>
</tbody>
</table>
</div>
...
<div class="section" id="module-formats">
<h2>Module Formats<a class="headerlink" href="#module-formats" title="Permalink to this headline">¶</a></h2>
<p>webpack supports ES2015+, CommonJS and AMD modules <strong>out of the box</strong>. It performs clever static
...
<h2><a class="reference external" href="https://webpack.js.org/guides/code-splitting/">Code Splitting</a><a class="headerlink" href="#code-splitting" title="Permalink to this headline">¶</a></h2>
...
<h2><a class="reference external" href="https://webpack.js.org/guides/production-build/">Optimizations</a><a class="headerlink" href="#optimizations" title="Permalink to this headline">¶</a></h2>
...
through code splitting. It can also make your code chunks <strong>cache
friendly</strong> by using hashes.</p>
<h2 align="center">Contributing</h2>
<p><strong>We want contributing to webpack to be fun, enjoyable, and educational for anyone, and everyone.</strong> We have a <a class="reference external" href="https://medium.com/webpack/contributors-guide/home">vibrant ecosystem</a> that spans beyond this single repo. We welcome you to check out any of the repositories in <a class="reference external" href="http://github.com/webpack">our organization</a> or <a class="reference external" href="http://github.com/webpack-contrib">webpack-contrib organization</a> which houses all of our loaders and plugins.</p>
...
<ul class="simple">
<li><p><a class="reference external" href="https://github.com/webpack/webpack.js.org">Documentation</a> updates, enhancements, designs, or bugfixes</p></li>
<li><p>Spelling or grammar fixes</p></li>
<li><p>README.md corrections or redesigns</p></li>
<li><p>Adding unit, or functional tests</p></li>
<li><p>Triaging GitHub issues – especially determining whether an issue still persists or is reproducible.</p></li>
<li><p><a class="reference external" href="https://twitter.com/search?q=webpack">Searching #webpack on twitter</a> and helping someone else who needs help</p></li>
<li><p>Teaching others how to contribute to one of the many webpack’s repos!</p></li>
<li><p><a class="reference external" href="https://github.com/webpack-contrib/awesome-webpack">Blogging, speaking about, or creating tutorials</a> about one of webpack’s many features.</p></li>
<li><p>Helping others in our webpack <a class="reference external" href="https://gitter.im/webpack/webpack">gitter channel</a>.</p></li>
</ul>
<p>If you are worried or don’t know where to start, you can <strong>always</strong> reach out to <a class="reference external" href="https://twitter.com/thelarkinn">Sean Larkin (&#64;TheLarkInn) on Twitter</a> or simply submit an issue and a maintainer can help give you guidance!</p>
<p>We have also started a series on our <a class="reference external" href="https://medium.com/webpack">Medium Publication</a> called <a class="reference external" href="https://medium.com/webpack/contributors-guide/home">The Contributor’s Guide to webpack</a>. We welcome you to read it and post any questions or responses if you still need help.</p>
...
<p>If you create a loader or plugin, we would &lt;3 for you to open source it, and put it on npm. We follow the <code class="docutils literal notranslate"><span class="pre">x-loader</span></code>, <code class="docutils literal notranslate"><span class="pre">x-webpack-plugin</span></code> naming convention.</p>
...
<p>If you’re just getting started, take a look at <a class="reference external" href="https://webpack.js.org/concepts/">our new docs and concepts page</a>. This has a high level overview that is great for beginners!!</p>
<p>Looking for webpack 1 docs? Please check out the old <a class="reference external" href="https://github.com/webpack/docs/wiki/contents">wiki</a>, but note that this deprecated version is no longer supported.</p>
<p>If you want to discuss something or just need help, <a class="reference external" href="https://gitter.im/webpack/webpack">here is our Gitter room</a> where there are always individuals looking to help out!</p>
<p>If you are still having difficulty, we would love for you to post
a question to <a class="reference external" href="https://stackoverflow.com/tags/webpack">StackOverflow with the webpack tag</a>. It is much easier to answer questions that include your webpack.config.js and relevant files! So if you can provide them, we’d be extremely grateful (and more likely to help you find the answer!)</p>
...
<p><a class="reference external" href="https://app.fossa.io/projects/git%2Bhttps%3A%2F%2Fgithub.com%2Fwebpack%2Fwebpack?ref=badge_large"><img alt="FOSSA Status" src="https://app.fossa.io/api/projects/git%2Bhttps%3A%2F%2Fgithub.com%2Fwebpack%2Fwebpack.svg?type=large" /></a></p>
...
<ul class="simple">
<li><p>Allow the core team to work on webpack</p></li>
<li><p>Thank contributors if they invested a large amount of time in contributing</p></li>
<li><p>Support projects in the ecosystem that are of great value for users</p></li>
<li><p>Support projects that are voted most (work in progress)</p></li>
<li><p>Infrastructure cost</p></li>
<li><p>Fees for money handling</p></li>
</ul>
<h2 align="center">Premium Partners</h2>
<div align="center">
<p><a href="https://www.ag-grid.com/?utm_source=webpack&utm_medium=banner&utm_campaign=sponsorship" target="_blank"><img align="center" src="https://raw.githubusercontent.com/webpack/media/2b399d58/horiz-banner-ad-ag-grid.png">
</a></p>
</div>
...
<div align="center">
<p><a class="reference external" href="https://angular.io/">Google Angular Team</a>, <a class="reference external" href="http://architects.io/">Architects.io</a>,
...
src="https://static.monei.net/monei-logo.svg" height="30" alt="MONEI"></a></p>
</div>
<h2 align="center">Gold Sponsors</h2>
<p><a class="reference external" href="https://opencollective.com/webpack#sponsor">Become a gold sponsor</a> and get your logo on our README on Github with a link to your site.</p>
<div align="center">
<p><a href="https://opencollective.com/webpack/goldsponsor/0/website?requireActive=false" target="_blank"><img src="https://opencollective.com/webpack/goldsponsor/0/avatar.svg?requireActive=false"></a>
...
<a href="https://opencollective.com/webpack/goldsponsor/29/website?requireActive=false" target="_blank"><img src="https://opencollective.com/webpack/goldsponsor/29/avatar.svg?requireActive=false"></a></p>
</div>
<h2 align="center">Silver Sponsors</h2>
<p><a class="reference external" href="https://opencollective.com/webpack#sponsor">Become a silver sponsor</a> and get your logo on our README on Github with a link to your site.</p>
<div align="center">
<p><a href="https://opencollective.com/webpack/silversponsor/0/website?requireActive=false" target="_blank"><img src="https://opencollective.com/webpack/silversponsor/0/avatar.svg?requireActive=false"></a>
...
<a href="https://opencollective.com/webpack/silversponsor/29/website?requireActive=false" target="_blank"><img src="https://opencollective.com/webpack/silversponsor/29/avatar.svg?requireActive=false"></a></p>
</div>
<h2 align="center">Bronze Sponsors</h2>
<p><a class="reference external" href="https://opencollective.com/webpack#sponsor">Become a bronze sponsor</a> and get your logo on our README on Github with a link to your site.</p>
<div align="center">
<p><a href="https://opencollective.com/webpack/sponsor/0/website?requireActive=false" target="_blank"><img src="https://opencollective.com/webpack/sponsor/0/avatar.svg?requireActive=false"></a>
...
<a href="https://opencollective.com/webpack/sponsor/100/website?requireActive=false" target="_blank"><img src="https://opencollective.com/webpack/sponsor/100/avatar.svg?requireActive=false"></a></p>
</div>
<h2 align="center">Backers</h2>
<p><a class="reference external" href="https://opencollective.com/webpack#backer">Become a backer</a> and get your image on our README on Github with a link to your site.</p>
<p><a href="https://opencollective.com/webpack/backer/0/website?requireActive=false" target="_blank"><img src="https://opencollective.com/webpack/backer/0/avatar.svg?requireActive=false"></a>
...
<a href="https://opencollective.com/webpack/backer/100/website?requireActive=false" target="_blank"><img src="https://opencollective.com/webpack/backer/100/avatar.svg?requireActive=false"></a></p>
<h2 align="center">Special Thanks to</h2>
<p align="center">(In chronological order)</p>
<ul class="simple">
<li><p>&#64;google for <a class="reference external" href="http://www.gwtproject.org/">Google Web Toolkit (GWT)</a>, which aims to compile Java to JavaScript. It features a similar <a class="reference external" href="http://www.gwtproject.org/doc/latest/DevGuideCodeSplitting.html">Code Splitting</a> as webpack.</p></li>
<li><p>&#64;medikoo for <a class="reference external" href="https://github.com/medikoo/modules-webmake">modules-webmake</a>, which is a similar project. webpack was born because I wanted Code Splitting for modules-webmake. Interestingly the <a class="reference external" href="https://github.com/medikoo/modules-webmake/issues/7">Code Splitting issue is still open</a> (thanks also to &#64;Phoscur for the discussion).</p></li>
<li><p>&#64;substack for <a class="reference external" href="http://browserify.org/">browserify</a>, which is a similar project and source for many ideas.</p></li>
<li><p>&#64;jrburke for <a class="reference external" href="http://requirejs.org/">require.js</a>, which is a similar project and source for many ideas.</p></li>
<li><p>&#64;defunctzombie for the <a class="reference external" href="https://gist.github.com/defunctzombie/4339901">browser-field spec</a>, which makes modules available for node.js, browserify and webpack.</p></li>
<li><p>Every early webpack user, which contributed to webpack by writing issues or PRs. You influenced the direction…</p></li>
<li><p>&#64;shama, &#64;jhnns and &#64;sokra for maintaining this project</p></li>
<li><p>Everyone who has written a loader for webpack. You are the ecosystem…</p></li>
<li><p>Everyone I forgot to mention here, but also influenced webpack.</p></li>
</ul>
</div>
</div>
