...
<html>
  <head>
    ...
    <title>Acorn AST walker &#8212; Colab Experiment</title>
...
<main class="col py-md-3 pl-md-4 bd-content overflow-auto" role="main">
    ...
    <div class="dropdown-buttons">
        ...
        <!-- Download raw file -->
        <a class="dropdown-buttons" href="../../../../../../_sources/.cache/yarn/v6/npm-acorn-walk-7.2.0-0de889a601203909b0fbe07b8938dc21d2e967bc-integrity/node_modules/acorn-walk/README.md"><button type="button"
...
<div class="dropdown-buttons-trigger">
    ...
    <div class="dropdown-buttons sourcebuttons">
        ...
        <a class="issues-button"
            href="https://github.com/fm75/jbook-209/issues/new?title=Issue%20on%20page%20%2F.cache/yarn/v6/npm-acorn-walk-7.2.0-0de889a601203909b0fbe07b8938dc21d2e967bc-integrity/node_modules/acorn-walk/README.html&body=Your%20issue%20content%20here."><button
                type="button" class="btn btn-secondary topbarbtn" data-toggle="tooltip" data-placement="left"
                title="Open an issue"><i class="fas fa-lightbulb"></i>open issue</button></a>
        <a class="edit-button" href="https://github.com/fm75/jbook-209/edit/master/.cache/yarn/v6/npm-acorn-walk-7.2.0-0de889a601203909b0fbe07b8938dc21d2e967bc-integrity/node_modules/acorn-walk/README.md"><button
                type="button" class="btn btn-secondary topbarbtn" data-toggle="tooltip" data-placement="left"
 ...
 <li class="toc-h2 nav-item toc-entry">
  ...
  <div class="section" id="acorn-ast-walker">
<h1>Acorn AST walker<a class="headerlink" href="#acorn-ast-walker" title="Permalink to this headline">¶</a></h1>
<p>An abstract syntax tree walker for the
<a class="reference external" href="https://github.com/estree/estree">ESTree</a> format.</p>
...
<a class="reference external" href="https://github.com/acornjs/acorn/blob/master/acorn-walk/LICENSE">MIT license</a>.</p>
...
<div class="highlight-sh notranslate"><div class="highlight"><pre><span></span>npm install acorn-walk
</pre></div>
</div>
...
such a walker.</p>
<p><strong>simple</strong><code class="docutils literal notranslate"><span class="pre">(node,</span> <span class="pre">visitors,</span> <span class="pre">base,</span> <span class="pre">state)</span></code> does a ‘simple’ walk over a
tree. <code class="docutils literal notranslate"><span class="pre">node</span></code> should be the AST node to walk, and <code class="docutils literal notranslate"><span class="pre">visitors</span></code> an object
with properties whose names correspond to node types in the <a class="reference external" href="https://github.com/estree/estree">ESTree
spec</a>. The properties should contain
functions that will be called with the node object and, if applicable
the state at that point. The last two arguments are optional. <code class="docutils literal notranslate"><span class="pre">base</span></code>
is a walker algorithm, and <code class="docutils literal notranslate"><span class="pre">state</span></code> is a start state. The default
walker will simply visit all statements and expressions and not
produce a meaningful state. (An example of a use of state is to track
scope at each point in the tree.)</p>
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="kr">const</span> <span class="nx">acorn</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s2">&quot;acorn&quot;</span><span class="p">)</span>
<span class="kr">const</span> <span class="nx">walk</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s2">&quot;acorn-walk&quot;</span><span class="p">)</span>
...
<span class="nx">walk</span><span class="p">.</span><span class="nx">ancestor</span><span class="p">(</span><span class="nx">acorn</span><span class="p">.</span><span class="nx">parse</span><span class="p">(</span><span class="s2">&quot;foo(&#39;hi&#39;)&quot;</span><span class="p">),</span> <span class="p">{</span>
  <span class="nx">Literal</span><span class="p">(</span><span class="nx">_</span><span class="p">,</span> <span class="nx">ancestors</span><span class="p">)</span> <span class="p">{</span>
    <span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="s2">&quot;This literal&#39;s ancestors are:&quot;</span><span class="p">,</span> <span class="nx">ancestors</span><span class="p">.</span><span class="nx">map</span><span class="p">(</span><span class="nx">n</span> <span class="p">=&gt;</span> <span class="nx">n</span><span class="p">.</span><span class="nx">type</span><span class="p">))</span>
  <span class="p">}</span>
<span class="p">})</span>
</pre></div>
</div>
...
<p><strong>full</strong><code class="docutils literal notranslate"><span class="pre">(node,</span> <span class="pre">callback,</span> <span class="pre">base,</span> <span class="pre">state)</span></code> does a ‘full’ walk over a
tree, calling the callback with the arguments (node, state, type) for
each node</p>
<p><strong>fullAncestor</strong><code class="docutils literal notranslate"><span class="pre">(node,</span> <span class="pre">callback,</span> <span class="pre">base,</span> <span class="pre">state)</span></code> does a ‘full’ walk
...
<p><strong>findNodeAt</strong><code class="docutils literal notranslate"><span class="pre">(node,</span> <span class="pre">start,</span> <span class="pre">end,</span> <span class="pre">test,</span> <span class="pre">base,</span> <span class="pre">state)</span></code> tries to locate
...
(testing outer nodes before inner nodes).</p>
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            kernelName: "python3",
            path: "./.cache/yarn/v6/npm-acorn-walk-7.2.0-0de889a601203909b0fbe07b8938dc21d2e967bc-integrity/node_modules/acorn-walk"
        },
