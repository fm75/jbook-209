...
<html>
  <head>
    ...
    <title>cacache &#8212; Colab Experiment</title>
...
<div class="dropdown-buttons-trigger">
    ...
    <div class="dropdown-buttons sourcebuttons">
        ...
        <a class="issues-button"
            href="https://github.com/fm75/jbook-209/issues/new?title=Issue%20on%20page%20%2F.cache/yarn/v6/npm-cacache-12.0.4-668bcbd105aeb5f1d92fe25570ec9525c8faa40c-integrity/node_modules/cacache/README.es.html&body=Your%20issue%20content%20here."><button
                type="button" class="btn btn-secondary topbarbtn" data-toggle="tooltip" data-placement="left"
                title="Open an issue"><i class="fas fa-lightbulb"></i>open issue</button></a>
        <a class="edit-button" href="https://github.com/fm75/jbook-209/edit/master/.cache/yarn/v6/npm-cacache-12.0.4-668bcbd105aeb5f1d92fe25570ec9525c8faa40c-integrity/node_modules/cacache/README.es.md"><button
                type="button" class="btn btn-secondary topbarbtn" data-toggle="tooltip" data-placement="left"
...
<p><a class="reference external" href="https://github.com/zkat/cacache"><code class="docutils literal notranslate"><span class="pre">cacache</span></code></a> es una librería de Node.js para
...
<li><p><a class="reference external" href="#caracter%C3%ADsticas">Características</a></p></li>
<li><p><a class="reference external" href="#c%C3%B3mo-contribuir">Cómo Contribuir</a></p></li>
<li><p><a class="reference external" href="#api">API</a></p>
<ul>
<li><p><a class="reference external" href="#localized-api">Usando el API en español</a></p></li>
<li><p>Leer</p>
<ul>
...
<span class="kr">const</span> <span class="nx">clave</span> <span class="o">=</span> <span class="s1">&#39;mi-clave-única-1234&#39;</span>

<span class="c1">// ¡Añádelo al caché! Usa `rutaCache` como raíz del caché.</span>
...
<span class="c1">// Copia el contenido del caché a otro fichero, pero esta vez con flujos.</span>
...
<span class="p">).</span><span class="nx">on</span><span class="p">(</span><span class="s1">&#39;finish&#39;</span><span class="p">,</span> <span class="p">()</span> <span class="p">=&gt;</span> <span class="p">{</span>
  <span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="s1">&#39;extracción completada&#39;</span><span class="p">)</span>
<span class="p">})</span>

<span class="c1">// La misma cosa, pero accesando el contenido directamente, sin tocar el índice.</span>
...
<ul class="simple">
<li><p>Extracción por clave o por dirección de contenido (shasum, etc)</p></li>
<li><p>Usa el estándard de web, <a class="reference external" href="#integrity">Subresource Integrity</a></p></li>
<li><p>Compatible con multiples algoritmos - usa sha1, sha512, etc, en el mismo caché sin problema</p></li>
<li><p>Entradas con contenido idéntico comparten ficheros</p></li>
<li><p>Tolerancia de fallas (inmune a corrupción, ficheros parciales, carreras de proceso, etc)</p></li>
<li><p>Verificación completa de datos cuando (escribiendo y leyendo)</p></li>
<li><p>Concurrencia rápida, segura y “lockless”</p></li>
...
<li><p>Bastante rápida – acceso, incluyendo verificación, en microsegundos</p></li>
<li><p>Almacenaje de metadatos arbitrarios</p></li>
<li><p>Colección de basura y verificación adicional fuera de banda</p></li>
<li><p>Cobertura rigurosa de pruebas</p></li>
<li><p>Probablente hay un “Bloom filter” por ahí en algún lado. Eso le mola a la gente, ¿Verdad? 🤔</p></li>
</ul>
</div>
<div class="section" id="como-contribuir">
<h3>Cómo Contribuir<a class="headerlink" href="#como-contribuir" title="Permalink to this headline">¶</a></h3>
<p>El equipo de cacache felizmente acepta contribuciones de código y otras maneras de participación. ¡Hay muchas formas diferentes de contribuir! La <span class="xref myst">Guía de Colaboradores</span> (en inglés) tiene toda la información que necesitas para cualquier tipo de contribución: todo desde cómo reportar errores hasta cómo someter parches con nuevas características. Con todo y eso, no se preocupe por si lo que haces está exáctamente correcto: no hay ningún problema en hacer preguntas si algo no está claro, o no lo encuentras.</p>
<p>El equipo de cacache tiene miembros hispanohablantes: es completamente aceptable crear <code class="docutils literal notranslate"><span class="pre">issues</span></code> y <code class="docutils literal notranslate"><span class="pre">pull</span> <span class="pre">requests</span></code> en español/castellano.</p>
<p>Todos los participantes en este proyecto deben obedecer el <span class="xref myst">Código de Conducta</span> (en inglés), y en general actuar de forma amable y respetuosa mientras participan en esta comunidad.</p>
<p>Por favor refiérase al <a class="reference internal" href="CHANGELOG.html"><span class="doc std std-doc">Historial de Cambios</span></a> (en inglés) para detalles sobre cambios importantes incluídos en cada versión.</p>
<p>Finalmente, cacache tiene un sistema de localización de lenguaje. Si te interesa añadir lenguajes o mejorar los que existen, mira en el directorio <code class="docutils literal notranslate"><span class="pre">./locales</span></code> para comenzar.</p>
<p>Happy hacking!</p>
</div>
<div class="section" id="api">
<h3>API<a class="headerlink" href="#api" title="Permalink to this headline">¶</a></h3>
<div class="section" id="a-name-localized-api-a-usando-el-api-en-espanol">
<h4><a name="localized-api"></a> Usando el API en español<a class="headerlink" href="#a-name-localized-api-a-usando-el-api-en-espanol" title="Permalink to this headline">¶</a></h4>
...
<p>cacache también tiene otros lenguajes: encuéntralos bajo <code class="docutils literal notranslate"><span class="pre">./locales</span></code>, y podrás
...
<span class="p">{</span>
  <span class="s1">&#39;my-thing&#39;</span><span class="o">:</span> <span class="p">{</span>
    ...
    <span class="nx">time</span><span class="o">:</span> <span class="mi">12345698490</span><span class="p">,</span>
    <span class="nx">size</span><span class="o">:</span> <span class="mi">4023948</span><span class="p">,</span>
  ...
  <span class="s1">&#39;other-thing&#39;</span><span class="o">:</span> <span class="p">{</span>
    ...
    <span class="nx">time</span><span class="o">:</span> <span class="mi">11992309289</span><span class="p">,</span>
    <span class="nx">size</span><span class="o">:</span> <span class="mi">111112</span>
  <span class="p">}</span>
<span class="p">}</span>
</pre></div>
</div>
...
<span class="p">{</span>
  ...
  <span class="nx">path</span><span class="o">:</span> <span class="s1">&#39;.testcache/content/deadbeef&#39;</span><span class="p">,</span> <span class="c1">// unido con `rutaCache`</span>
  <span class="nx">time</span><span class="o">:</span> <span class="mi">12345698490</span><span class="p">,</span>
  <span class="nx">size</span><span class="o">:</span> <span class="mi">13423</span><span class="p">,</span>
  <span class="nx">metadata</span><span class="o">:</span> <span class="p">{</span>
    <span class="nx">name</span><span class="o">:</span> <span class="s1">&#39;blah&#39;</span><span class="p">,</span>
    <span class="nx">version</span><span class="o">:</span> <span class="s1">&#39;1.2.3&#39;</span><span class="p">,</span>
    <span class="nx">description</span><span class="o">:</span> <span class="s1">&#39;this was once a package but now it is my-thing&#39;</span>
...
<span class="p">{</span>
  ...
  <span class="nx">path</span><span class="o">:</span> <span class="s1">&#39;.testcache/content/bada55&#39;</span><span class="p">,</span>
  <span class="nx">time</span><span class="o">:</span> <span class="mi">11992309289</span><span class="p">,</span>
  <span class="nx">size</span><span class="o">:</span> <span class="mi">498023984029</span>
<span class="p">}</span>
...
por la <code class="docutils literal notranslate"><span class="pre">clave</span></code>. La propiedad <code class="docutils literal notranslate"><span class="pre">data</span></code> de este objeto será una instancia de
<code class="docutils literal notranslate"><span class="pre">Buffer</span></code> con los datos almacenados en el caché. to do with it! cacache just
won’t care.</p>
<p><code class="docutils literal notranslate"><span class="pre">integrity</span></code> es un <code class="docutils literal notranslate"><span class="pre">string</span></code> de <a class="reference external" href="#integrity">Subresource Integrity</a>. Dígase, un
...
almacenados localmente fallan verificación, el <code class="docutils literal notranslate"><span class="pre">Promise</span></code> fallará.</p>
<p>Una sub-función, <code class="docutils literal notranslate"><span class="pre">saca.porHacheo</span></code>, tiene casi el mismo comportamiento, excepto
que busca entradas usando el hacheo de integridad, sin tocar el índice general.
Esta versión <em>sólo</em> devuelve <code class="docutils literal notranslate"><span class="pre">data</span></code>, sin ningún objeto conteniéndola.</p>
...
<p>So no existe ninguna entrada identificada por <code class="docutils literal notranslate"><span class="pre">clave</span></code>, o se los datos
almacenados localmente fallan verificación, el <code class="docutils literal notranslate"><span class="pre">Promise</span></code> fallará.</p>
<p><code class="docutils literal notranslate"><span class="pre">metadata</span></code> y <code class="docutils literal notranslate"><span class="pre">integrity</span></code> serán emitidos como eventos antes de que el flujo
cierre.</p>
<p>Una sub-función, <code class="docutils literal notranslate"><span class="pre">saca.flujo.porHacheo</span></code>, tiene casi el mismo comportamiento,
excepto que busca entradas usando el hacheo de integridad, sin tocar el índice
general. Esta versión no emite eventos de <code class="docutils literal notranslate"><span class="pre">metadata</span></code> o <code class="docutils literal notranslate"><span class="pre">integrity</span></code>.</p>
...
<p>Busca la <code class="docutils literal notranslate"><span class="pre">clave</span></code> en el índice del caché, devolviendo información sobre la
entrada si existe.</p>
...
<li><p><code class="docutils literal notranslate"><span class="pre">path</span></code> - Dirección del fichero de datos almacenados, unida al argumento <code class="docutils literal notranslate"><span class="pre">cache</span></code>.</p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">time</span></code> - Hora de creación de la entrada</p></li>
...
<span class="p">{</span>
  ...
  <span class="nx">time</span><span class="o">:</span> <span class="mi">12345698490</span><span class="p">,</span>
  <span class="nx">size</span><span class="o">:</span> <span class="mi">849234</span><span class="p">,</span>
  <span class="nx">metadata</span><span class="o">:</span> <span class="p">{</span>
    <span class="nx">name</span><span class="o">:</span> <span class="s1">&#39;blah&#39;</span><span class="p">,</span>
    <span class="nx">version</span><span class="o">:</span> <span class="s1">&#39;1.2.3&#39;</span><span class="p">,</span>
    <span class="nx">description</span><span class="o">:</span> <span class="s1">&#39;this was once a package but now it is my-thing&#39;</span>
...
<p>Busca un <a class="reference external" href="#integrity">hacheo Subresource Integrity</a> en el caché. Si existe el
...
<em>específico</em> que se usó para la búsqueda, <code class="docutils literal notranslate"><span class="pre">sri</span></code>, y el tamaño total del
contenido, <code class="docutils literal notranslate"><span class="pre">size</span></code>. Si no existe ningún contenido asociado con <code class="docutils literal notranslate"><span class="pre">integrity</span></code>,
...
<span class="p">{</span>
  ...
  <span class="p">},</span>
  <span class="nx">size</span><span class="o">:</span> <span class="mi">9001</span>
<span class="p">}</span>
...
<p>Inserta <code class="docutils literal notranslate"><span class="pre">datos</span></code> en el caché. El <code class="docutils literal notranslate"><span class="pre">Promise</span></code> devuelto se resuelve con un hacheo
(generado conforme a <a class="reference external" href="#optsalgorithms"><code class="docutils literal notranslate"><span class="pre">ops.algorithms</span></code></a>) después que la entrada
...
al caché los datos escritos a él. Emite un evento <code class="docutils literal notranslate"><span class="pre">integrity</span></code> con el hacheo del
...
<p>La funciones <code class="docutils literal notranslate"><span class="pre">cacache.mete</span></code> tienen un número de opciones en común.</p>
...
error con código <code class="docutils literal notranslate"><span class="pre">EBADSIZE</span></code>.</p>
</div>
...
con un error con código <code class="docutils literal notranslate"><span class="pre">EINTEGRITY</span></code>.</p>
<p><code class="docutils literal notranslate"><span class="pre">ops.algorithms</span></code> no tiene ningún efecto si esta opción está presente.</p>
</div>
...
valor). No tiene ningún efecto si <code class="docutils literal notranslate"><span class="pre">ops.integrity</span></code> también ha sido proveido.</p>
</div>
...
objeto con métodos <code class="docutils literal notranslate"><span class="pre">get()</span></code> y <code class="docutils literal notranslate"><span class="pre">set()</span></code>), este objeto en sí sera usado en vez del
...
<p>Borra la entrada <code class="docutils literal notranslate"><span class="pre">clave</span></code> del índuce. El contenido asociado con esta entrada
...
<p>Para borrar el contenido en sí, usa <a class="reference external" href="#rm-content"><code class="docutils literal notranslate"><span class="pre">rm.datos</span></code></a>. Si quieres hacer
esto de manera más segura (pues ficheros de contenido pueden ser usados por
multiples entradas), usa <a class="reference external" href="#verify"><code class="docutils literal notranslate"><span class="pre">verifica</span></code></a> para borrar huérfanos.</p>
...
accesar, al menos que contenido idéntico sea añadido bajo <code class="docutils literal notranslate"><span class="pre">integrity</span></code>.</p>
...
lenguajes disponibles está en el directorio <code class="docutils literal notranslate"><span class="pre">./locales</span></code> del proyecto.</p>
<p><em>Te interesa añadir más lenguajes? <span class="xref myst">Somete un PR</span>!</em></p>
</div>
...
propio objecto con <code class="docutils literal notranslate"><span class="pre">ops.memoize</span></code>, debes hacer esto de manera específica a él.</p>
</div>
...
<p>Devuelve un directorio único dentro del directorio <code class="docutils literal notranslate"><span class="pre">tmp</span></code> del caché.</p>
<p>Una vez tengas el directorio, es responsabilidad tuya asegurarte que todos los
ficheros escrito a él sean creados usando los permisos y <code class="docutils literal notranslate"><span class="pre">uid</span></code>/<code class="docutils literal notranslate"><span class="pre">gid</span></code> concordante
con el caché. Si no, puedes pedirle a cacache que lo haga llamando a
<a class="reference external" href="#tmp-fix"><code class="docutils literal notranslate"><span class="pre">cacache.tmp.fix()</span></code></a>. Esta función arreglará todos los permisos en el
directorio tmp.</p>
...
<p>cacache usa strings que siguen la especificación de <a class="reference external" href="https://developer.mozilla.org/en-US/docs/Web/Security/Subresource_Integrity">Subresource Integrity
spec</a>.</p>
<p>Es decir, donde quiera cacache espera un argumento o opción <code class="docutils literal notranslate"><span class="pre">integrity</span></code>, ese
string debería usar el formato <code class="docutils literal notranslate"><span class="pre">&lt;algoritmo&gt;-&lt;hacheo-base64&gt;</span></code>.</p>
...
Puedes usar <code class="docutils literal notranslate"><span class="pre">crypto.getHashes()</span></code> para ver cuales están disponibles.</p>
...
(es decir, un <code class="docutils literal notranslate"><span class="pre">sha1</span></code> se vería como algo así:
...
anterior sería: <code class="docutils literal notranslate"><span class="pre">sha1-X1UT+IIv2+UUWvM7ZNjZcNz5XG4=</span></code>.</p>
...
<p>También puedes usar <a class="reference external" href="https://npm.im/ssri"><code class="docutils literal notranslate"><span class="pre">ssri</span></code></a> para deferir el trabajo a otra
...
<ul class="simple">
<li><p>Limpia entradas inválidas, huérfanas y corrompidas</p></li>
<li><p>Te deja filtrar cuales entradas retener, con tu propio filtro</p></li>
<li><p>Reclama cualquier ficheros de contenido sin referencias en el índice</p></li>
<li><p>Verifica integridad de todos los ficheros de contenido y remueve los malos</p></li>
<li><p>Arregla permisos del caché</p></li>
<li><p>Remieve el directorio <code class="docutils literal notranslate"><span class="pre">tmp</span></code> en el caché, y todo su contenido.</p></li>
</ul>
...
<ul class="simple">
<li><p><code class="docutils literal notranslate"><span class="pre">ops.uid</span></code> - uid para asignarle al caché y su contenido</p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">ops.gid</span></code> - gid para asignarle al caché y su contenido</p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">ops.filter</span></code> - recibe una entrada como argumento. Devuelve falso para removerla. Nota: es posible que esta función sea invocada con la misma entrada más de una vez.</p></li>
</ul>
</div>
...
<p>Alias: <code class="docutils literal notranslate"><span class="pre">últimaVez</span></code></p>
<p>Devuelve un <code class="docutils literal notranslate"><span class="pre">Date</span></code> que representa la última vez que <code class="docutils literal notranslate"><span class="pre">cacache.verifica</span></code> fue
...
<div class="highlight-javascript notranslate"><div class="highlight"><pre><span></span><span class="nx">cacache</span><span class="p">.</span><span class="nx">verifica</span><span class="p">(</span><span class="nx">rutaCache</span><span class="p">).</span><span class="nx">then</span><span class="p">(()</span> <span class="p">=&gt;</span> <span class="p">{</span>
  <span class="nx">cacache</span><span class="p">.</span><span class="nx">verifica</span><span class="p">.</span><span class="nx">ultimaVez</span><span class="p">(</span><span class="nx">rutaCache</span><span class="p">).</span><span class="nx">then</span><span class="p">(</span><span class="nx">última</span> <span class="p">=&gt;</span> <span class="p">{</span>
    <span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="s1">&#39;La última vez que se usó cacache.verifica() fue &#39;</span> <span class="o">+</span> <span class="nx">última</span><span class="p">)</span>
  <span class="p">})</span>
<span class="p">})</span>
</pre></div>
</div>
